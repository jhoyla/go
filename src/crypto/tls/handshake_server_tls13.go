...
func (hs *serverHandshakeStateTLS13) pickCertificate() error {
	...
	if hs.clientHello.delegatedCredentialSupported && len(hs.clientHello.supportedSignatureAlgorithmsDC) > 0 {
		...
		if delegatedCredentialPair.DC != nil && delegatedCredentialPair.PrivateKey != nil {
			...
			hs.sigAlg, err = selectSignatureSchemeDC(c.vers, delegatedCredentialPair.DC, hs.clientHello.supportedSignatureAlgorithms, hs.clientHello.supportedSignatureAlgorithmsDC)
			if err != nil {
